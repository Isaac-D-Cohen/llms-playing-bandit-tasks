...
if __name__ == "__main__":
    ...
    solvers.append(LLM(f"gpt-3.5-turbo temp=0.0", model=model, temperature=0.0, save_every_nth_response=5))
    model = GPT("gpt-3.5-turbo-0613", api_key)
    solvers.append(LLM(f"gpt-3.5-turbo temp=1.0", model=model, temperature=1.0, save_every_nth_response=5))
